...
//        // TODO Implement method
//        int removedElement = arr.remove(index);
...
//        }
//        arr.subList(index, index + num).clear();
//    }
//
//
//    /**
...
//        }
//        if (index + num >= this.arr.size()) {
//            num = this.arr.size() - index;
//        }
//        ArrayList<Integer> removed = new ArrayList<>();
//        for (int i = index + num - 1; i >= index; i--) {
//            removed.add(0, this.arr.remove(i));
//        }
